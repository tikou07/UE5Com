function setup_sfun_zeromq_control_m_mask(block)
...
if ~strcmp(sfun_name, 'sfun_zeromq_control_m')
    error('This script is intended for "sfun_zeromq_control_m". The selected block is "%s".', sfun_name);
end
...
mask.Description = 'Publishes camera transform commands via ZeroMQ.';
